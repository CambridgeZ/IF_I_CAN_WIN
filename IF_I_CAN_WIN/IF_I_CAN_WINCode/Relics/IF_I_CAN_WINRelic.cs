...
using IF_I_CAN_WIN.IF_I_CAN_WINCode.Extensions;

namespace IF_I_CAN_WIN.IF_I_CAN_WINCode.Relics;
...
/// </summary>
public abstract class IF_I_CAN_WINRelic : CustomRelicModel
{
    //IF_I_CAN_WIN/images/relics
